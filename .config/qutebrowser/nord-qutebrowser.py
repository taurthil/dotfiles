...
## Type: QssColor
c.colors.completion.category.bg = nord['background']

## Bottom border color of the completion widget category headers.
## Type: QssColor
c.colors.completion.category.border.bottom = nord['background']

## Top border color of the completion widget category headers.
## Type: QssColor
c.colors.completion.category.border.top = nord['background']
...
## Type: QssColor
c.colors.completion.even.bg = nord['background']

## Background color of the completion widget for odd rows.
## Type: QssColor
c.colors.completion.odd.bg = nord['background']
...
## Type: QssColor
c.colors.completion.scrollbar.bg = nord['background']
...
## Type: QssColor
c.colors.downloads.bar.bg = nord['background']
...
## Type: QssColor
c.colors.hints.fg = nord['background']
...
## Type: QssColor
c.colors.keyhint.bg = nord['background']
...
# ## Type: String
c.colors.prompts.border = '1px solid ' + nord['background']
...
## Type: QssColor
c.colors.statusbar.insert.fg = nord['background']

## Background color of the statusbar.
## Type: QssColor
c.colors.statusbar.normal.bg = nord['background']
...
# ## Type: QtColor
c.colors.tabs.selected.even.bg = nord['background']
...
# ## Type: QtColor
c.colors.tabs.selected.odd.bg = nord['background']
